...
dbutils.widgets.text("test_database", "AdventureWorks", "SQL Server database")
dbutils.widgets.text("test_schema", "dbo", "SQL Server schema")
dbutils.widgets.text("test_table", "Employees", "SQL Server table")
